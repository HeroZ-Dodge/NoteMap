...
public class MapActivity extends BaseActivity {
    ...
    private void initMap() {
        ...
        mLocationClient.registerLocationListener(this::onReceiveLocation);
        mMap.setOnMapLoadedCallback(() -> mLocationClient.start());

    }

    private void onReceiveLocation(BDLocation location) {
        //Receive Location
